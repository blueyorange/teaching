...
- One becquerel is equivalent to one radioactive decay per second.

---

# How to find number of counts

count rate = counts of radiation &divide; time

so **Counts** = **Count Rate** &times; **Time**
...
Some isotopes are \_\_\_\_\_. This means they undergo radioactive \_\_\_\_\_ and emit \_\_\_\_\_ radiation. The number of radioactive decays per second is called the \_\_\_\_\_. We measure the \_\_\_\_\_ using a radiation detector to detect number of counts over a period of time and then divide by time taken.

**ionising** **unstable** **activity** **decay**  **count-rate**

---

### :green_circle: Nuclear radiation

Some isotopes are *unstable*. This means they undergo radioactive *decay* and emit *ionising* radiation. The number of radioactive decays per second is called the *activity*. We measure the *count rate* using a radiation detector.
